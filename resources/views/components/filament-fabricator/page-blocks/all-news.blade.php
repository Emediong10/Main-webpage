@aware(['page'])
@props(['url_prefix', 'news', 'news_pagination'])
...
<section id="content" style="background-color: #D7F2C3 !important;">
    ...
    <div class="content-wrap pb-0">
        <div class="container mb-5">
            <div class="p-3 pb-4">
                <h1 class="mb-4 h2 font-secondary fw-bold lh-base">Check Out Our news Below</h1>
            </div>
                        ...
                        <div class="p-4">
                            <div class="entry-title title-sm">
                                <h3 class="nott ls0 h5">
                                    {{ Illuminate\Support\Str::limit(strip_tags($news_item['title']), 30, '...') }}
                                </h3>
                            </div>
                            <div class="entry-meta">
                                <ul>
                                    <li><i class="icon-calendar3"></i> {{ \Carbon\Carbon::parse($news_item->created_at)->format('M d Y') }}</li>
                                    <li><i class="icon-user"></i> {{ $news_item['author']}}</li>
        ...
        <div style="float: right; padding: 10px;">{!! $news->appends(Illuminate\Support\Facades\Request::except('per_page'))->links() !!}
        </div>
        <div class="line"></div>
    </div>
</section>
